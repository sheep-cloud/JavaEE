...
//        
        ...
        Set<String> keys = jedisClient.keys("weather:forecast*");
        log.info("JedisClientTest.testDel() >> keys : {}", keys);
//        Long del = jedisClient.del(ArrayUtil.toArray(keys, String.class));
//        log.info("JedisClientTest.testDel() >> keys : {}", del);
    }

...
public class CodeGeneratorTest {
    ...
    public static void genService(String tableName, String modelName) {
        ...
        data.set("modelNameUpperCamel", modelNameUpperCamel)
            .set("modelNameLowerCamel", tableNameConvertLowerCamel(StrUtil.isEmpty(modelName) ? tableName : modelName)).set("basePackage", BASE_PACKAGE);
    ...
    public static void genController(String tableName, String modelName) {
        ...
        String modelNameUpperCamel = StrUtil.isEmpty(modelName) ? tableNameConvertUpperCamel(tableName) : modelName;
        data.set("author", AUTHOR).set("baseRequestMapping", modelNameConvertMappingPath(modelNameUpperCamel)).set("modelNameUpperCamel", modelNameUpperCamel)
            .set("modelNameLowerCamel", CaseFormat.UPPER_CAMEL.to(CaseFormat.LOWER_CAMEL, modelNameUpperCamel)).set("basePackage", BASE_PACKAGE);

...
public class DeptControllerConsumer {
    ...
    public ResultBean get(@PathVariable Long id) {
        return restTemplate.getForObject(REST_URL_PREFIX + "/dept/get/" + id, ResultBean.class);
    }
    ...
    public ResultBean add(Dept dept) {
        return restTemplate.postForObject(REST_URL_PREFIX + "/dept/add", dept, ResultBean.class);
    }
}

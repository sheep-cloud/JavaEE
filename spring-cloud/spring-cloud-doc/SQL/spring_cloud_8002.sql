DROP DATABASE IF EXISTS spring_cloud_8002;
CREATE DATABASE spring_cloud_8002 CHARACTER SET UTF8;
USE spring_cloud_8002;
...
-- 授权
GRANT ALL ON spring_cloud_8002.* TO 'spring_cloud';
FLUSH PRIVILEGES;
